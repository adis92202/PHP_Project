...
<div class="flex flex-col items-center">
    ...
    <div class="w-1/4 p-6 text-center bg-white border-4 border-lime-200 rounded-b-lg shadow-md sm:p-8">
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <!--Submit Button-->
            <button type="submit" class="px-5 py-3 shadow text-amber-600 bg-amber-300 hover:bg-amber-400 hover:text-amber-100 font-semibold rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center focus:outline-none">Send</button>
            <!--Form END-->
        </form>
    </div>
</div>
